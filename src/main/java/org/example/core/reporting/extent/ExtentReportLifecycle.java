...
public class ExtentReportLifecycle implements ReportingListener {
    ...
    // =======================================================================
    // Framework-agnostic handlers (use TestContext instead of ITestResult)
    // =======================================================================
    ...
    private void onTestStart(TestContext context, String testName) {
        ...
        String fullTestName = "[" + browser + "] " + testClass + "." + testName;
    ...
    private void onTestFailure(TestContext context, Throwable error) {
        ...
        if (error instanceof AssertionError && org.example.core.assertion.Assertions.isAssertionLogged()) {
            if (test != null) {
    ...
    private void onConfigurationSuccess(TestContext context) {
        ...
        // This is TestNG-specific behavior, but we handle it generically
    ...
    private ExtentTest getLastTestFromContext() {
        // This is a simplified version - in TestNG, we'd get from TestContext
        // For now, return the most recently created test
